...
assert_eq( db.get( "objs",[0..99] ),                    {0..99 => {4..6=>"bar", 3..4=>"blub", 1..5=>"bla"}} )
assert_eq( db.get( "objs",[6..100] ),                         {6..100 => {4..6=>"bar", 100..1001=>"fnord"}} )

assert_eq( db.del( "objs", [1..5] ),                                                                    :ok )
assert_eq( db.get( "objs", [0..99] ),                                {0..99 => {4..6=>"bar", 3..4=>"blub"}} )

assert_eq( db.delall( "objs", [6..100] ),                                                               :ok )
assert_eq( db.get( "objs", [0..1000] ),                                           {0..1000=>{3..4=>"blub"}} )
assert_eq( db.get( "null", [0..1000] ),                                                                  {} )

assert_eq( db.bdel( "mem", [0..1001] ),                                                                 :ok )
assert_eq( db.bput( "mem", {1..1 => "a", 2..3 => "bc", 4..6 => "def"} ),                                :ok )
assert_eq( db.bget( "mem", [0..1000] ),                                     {0..1000=>{1..6=>"abcdef"}} )
assert_eq( db.bdel( "mem", [2..3] ),                                                                    :ok )
assert_eq( db.bget( "mem", [0..1000] ),                            {0..1000=>{1..1=>"a", 4..6 =>"def"}} )
